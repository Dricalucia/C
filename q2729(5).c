...
/*
Este código esta apresentando Ok no VS Code
No replit a saida esta começando logo apos ao ultimo caractere da 2a linha
No Beecrod apresenta o erro 'Runtime error', porque esta dando buffer overflow detected */
